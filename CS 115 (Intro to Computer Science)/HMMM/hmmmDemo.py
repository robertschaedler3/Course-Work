...
00	read r1		    # user input counter
01	setn r2 0	    # fib(0)
02	setn r3 1	    # fib(1)
03	setn r4 1       # amount to decrement counter by
04	setn r5 0       # result
05	jeqzn r1 13     # if r1 == 0 print 0 
06	write r2        # print the current 
07  add r5 r3 r2    # n = (n-1) + (n-2)
08	copy r2 r3      # shift (n-1) to (n-2) for next iteration
09  copy r3 r5      # shift (n) to (n-1) for next iteration   
10  sub r1 r1 r4    # decrement counter
11	jumpn 5	        # return to the beginning of the loop
12	write r5        # print final number
13  halt
"""
