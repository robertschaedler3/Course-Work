...
(define (wj-help fillA fillB maxA maxB goal helper-list)
  (cond
    ((= fillB goal) (reverse (cons (list fillA fillB) helper-list)))
    ((= fillB maxB) (wj-help fillA 0 maxA maxB goal (cons (list fillA fillB) helper-list)))
    ((= fillA 0) (wj-help maxA fillB maxA maxB goal (cons (list fillA fillB) helper-list)))
    ((> (+ fillA fillB) maxB) (wj-help (- fillA (- maxB fillB)) maxB maxA maxB goal (cons (list fillA fillB) helper-list)))
    ((<= (+ fillA fillB) maxB) (wj-help 0 (+ fillA fillB) maxA maxB goal (cons (list fillA fillB) helper-list)))))
